// Projects data utility for reusable project information across desktop and mobile components
...
export const projects = [
  ...
  },
  {
    id: 10,
    title: "Blot",
    description: "I created a plotting device that generates a unique flower design just for you, chosen from over 80 million possible variations. Initially intended as a Mother's Day gift, the project became a personal challenge and a return to coding after a two-month break due to school and exams. Building it was a mostly enjoyable experience, though I relied heavily on trial and error and console logs before discovering the documentation for the blot library. Crafting circles was particularly tricky, but it allowed me to refresh my trigonometry skills. Overall, it was a fun and rewarding project, reigniting my passion for coding.",
...
// Utility functions for filtering and formatting project data
export const getProjectsByCategory = (category) => {
  // Add logic here if you want to categorize projects
  return projects;
};
...
export const getAvailableLinks = (project) => {
  return project.links.filter(link => link.aval);
};
...
export default { icons, projects, getProjectsByCategory, getProjectById, getAvailableLinks, getProjectColors };
